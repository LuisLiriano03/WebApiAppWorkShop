...
namespace GestionProyectos.DAL.Repositorios
{
    public class GenericRepository<TModelo> : IGenericRepository<TModelo> where TModelo : class
    {
        private readonly DbgestionProyectosUsuariosContext _dbcontext;

        public GenericRepository(DbgestionProyectosUsuariosContext dbcontext)
        {
